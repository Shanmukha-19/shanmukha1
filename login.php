<?php
	...
	if (isset($_POST['next2'])){
				...
				mysqli_query("INSERT INTO member(lastname,firstname,gender,userid,password,email,contactno,birthdate,address,verification,memberimg) VALUES ('$lname','$fname','$gender','$userid','$password','$email','$contactno','$birthdate','$cusaddress','no','default.jpg')");
				$query = mysqli_query("SELECT * FROM member WHERE userid = '$userid'") or die (mysqli_error());
					$row = mysqli_fetch_array($query);
					$id= $row['memberid'];
					mysqli_query("INSERT into secretquestions(memberid,question,answer) VALUES ('$id','$secques','$secanswer')");
				$_SESSION['ID']= $id;
