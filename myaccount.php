...
<script type='text/javascript'>
	...
	mysqliquery("INSERT INTO products(prodname,categoryid,prodescription,startingbid,prodimage,dateposted,duedate,status,sellername,sellerpayaccount) 
						VALUES ('$prodname','$category','$descrpt','$startingbid','$name','$datenow','$duedate',0,'$username','$selleracc')") or die(mysqli_error());
          ...
          <div class="details_big_box">
            ...
            <div class="specifications">
			 ...
			 <div id="regstep1">
				...
				mysqli_query("UPDATE member SET lastname='$last_save', firstname='$fname_save', gender='$gender_save', address='$address_save', birthdate='$bday_save' WHERE memberid='$userid'") or die (mysqli_error());
           ...
           <strong>Contact:</strong> 
			...
			mysqli_query("UPDATE member SET password='$password_save', memberimg='$name' WHERE memberid='$userid'") or die(mysqli_error());
				...
				<div class="specifications">
					...
					<div class='hidenotif'>
						<div class="thumbs">
							...
							<?php
								$get = mysqli_query("SELECT * FROM needtopay WHERE needtopay.memberid = '$userid' AND needtopay.status=0")or die(mysqli_error());
