           ...
           <div class="product_img_big">
			...
			<div class="details_big_box">
				<div class='proddet'>
					...
					<div class="specifications"> Description: <span class="blue"><?php echo $row['prodescription'];?></span><br /><br />
						...
						<?php
							...
							$categ = mysqli_query("SELECT * FROM pcategories WHERE categoryid = '$categid'")or die(mysqli_error());
				...
				<?php
							$id = $_GET['id'];
							$_SESSION['prodid'] = $id;
							$query = mysqli_query("SELECT * FROM products WHERE productid = '$id'") or die (mysqli_error());
							$row = mysqli_fetch_array($query);
							...
							$query2 = mysqli_query("SELECT * FROM bidreport WHERE productid = '$prodid'") or die (mysqli_error());
							$noofbidders = MYSQLI_NUMROWS($query2);
							...
							$highestbidder = mysqli_query("SELECT * FROM bidreport WHERE bidamount = '$highbid'")or die(mysqli_error());
							...
							echo"</span>
								...
								<?php 
								$name = mysqli_query("SELECT * FROM member WHERE memberid = '$hibidder'")or die(mysqli_error());
