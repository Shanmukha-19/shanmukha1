  ...
  <div id="main_content">
    ...
    <div class="crumb_navigation"> Navigation: <span class="current">Home</span> </div>
      ...
      <div class="border_box">
        <div class="product_title"><a href="showprod.php">Motorola 156 MX-VL</a></div>
        <div class="product_img"><a href="showprod.php"><img src="images/laptop.png" alt="" border="0" /></a></div>
    ...
    <!-- <div class="right_content">
      ...
      <ul class="left_menu">
        <li class="odd"><a href="details.php">Sony</a></li>
