		...
		<div class="prod_box_big">
			...
			<div class="reg_form">
				<div id="regstep1">
				 ...
				 <li>Provide a system that can accommodate bidding transaction. </li>
				</span>
				</div>
			</div>
			</div>
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
			 ...
			 <div class='companyfeedback'>
				 ...
				 item are available at Bidding Zone. Unless otherwise stated, all fees are quoted Indian rupees. You are responsible for paying
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
				...
				<div class='developer'>
					<div class="loginc">
					<br><br>					
					<span class="blue">Shanmukha</span>   
					<br><br><br>					 					
				</div>
			  </div>
			   </div>
